...
//            notification.tickerText = message;
            ...
            intentClick.putExtra(Constants.NOTIFICATION_ID, notificationId);
            intentClick.putExtra(Constants.NOTIFICATION_API_KEY, apiKey);
            intentClick.putExtra(Constants.NOTIFICATION_TITLE, title);
            intentClick.putExtra(Constants.NOTIFICATION_MESSAGE, message);
            intentClick.putExtra(Constants.NOTIFICATION_URI, uri);
            intentClick.putExtra(Constants.NOTIFICATION_IMAGE_URL, imageUrl);
   ...
   //NotificationManager manager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
            ...
            notificationManager.notify(getNotificationIcon(), notification);
