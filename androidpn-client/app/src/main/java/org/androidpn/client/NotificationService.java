...
public class NotificationService extends Service {
    ...
    private BroadcastReceiver showNotificationReceiver;
    ...
    public NotificationService() {
        showNotificationReceiver = new ShowNotificationReceiver();
...
//        filter.addAction(Constants.ACTION_NOTIFICATION_CLEARED);
        registerReceiver(showNotificationReceiver, filter);
