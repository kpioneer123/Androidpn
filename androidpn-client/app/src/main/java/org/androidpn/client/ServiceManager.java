...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
      ...
      //  xmppHost = props.getProperty("xmppHost", "172.16.3.224");
...
//                Intent intent = new Intent(String.valueOf(NotificationService.class));
//                context.startService(intent);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if(xmppManager!=null) {
                    ...
                    Log.d("TAG","authenticated already .send SetTagsIQ now...");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if(xmppManager !=null){
                    ...
                    Log.d("TAG","authenticated already .send SetAliasIQ now...");
